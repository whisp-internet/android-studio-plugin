...
class WhispApplicationComponent : ApplicationComponent, Disposable {
    ...
    override fun initComponent() {
        if (!ApplicationManager.getApplication().isUnitTestMode &&
            ...
            createWhispComponents()
        }
    }

    private fun createWhispComponents() {
    ...
    private fun createDynamicTemplateMenu() {
        ...
        TemplateManager.getTemplateRootFolder()?.let { studioTemplateFolder ->
            File(studioTemplateFolder, "whisp")
                .apply {
                    mkdirs()
